...
class MagazynGetView extends StatefulWidget {
  final id;
  final nazwa;
  final skladnik1;
  final gramatura1;
  ...
  @override
  State<MagazynGetView> createState() => _MagazynGetViewState();
}

class _MagazynGetViewState extends State<MagazynGetView> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> sendDeleteRequest() async {
    await http.put(
        Uri.parse(
            "https://us-east-1.aws.data.mongodb-api.com/app/tigms-loucm/endpoint/deleteMagazyn"),
        body: jsonEncode({
          "nazwa": widget.nazwa,
        }));
  }
