...
import 'package:tigms/screens/Produkcja/RecepturyGetView.dart';
import 'package:tigms/screens/Produkcja/RecepturyInstacja.dart';
import 'package:tigms/screens/Produkcja/RecepturyPost.dart';
import 'package:tigms/screens/Produkcja/RecepturyPut.dart';
import 'package:tigms/stale/constants.dart';
import 'package:http/http.dart' as http;

class RecepturyGet extends StatefulWidget {
  const RecepturyGet({super.key});

  @override
  State<RecepturyGet> createState() => _RecepturyGetState();
}

class _RecepturyGetState extends State<RecepturyGet> {
  @override
  void initState() {
    super.initState();
  }
                ...
                IconButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const RecepturyPost()));
                    },
                    icon: const Icon(
  ...
  static Future<List<RecepturyInstacja>> pobierzRecepturyInstacja() async {
    final response = await http.get(Uri.parse(
        "https://us-east-1.aws.data.mongodb-api.com/app/tigms-loucm/endpoint/getReceptury"));
              ...
              child: ListTile(
                ...
                onLongPress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RecepturyGetView(
                                nazwa: Receptury.nazwa,
                                skladnik1: Receptury.skladnik1,
                                gramatura1: Receptury.gramatura1,
                                skladnik2: Receptury.skladnik2,
